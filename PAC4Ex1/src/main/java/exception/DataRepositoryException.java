...
public class DataRepositoryException extends AppException {
  ...
  public static final String ERROR_DATA_ENTRY_EXISTS = "Data entry with this ID already exists.";
  public static final String ERROR_DATA_ENTRY_NOT_FOUND = "Data entry not found.";
  public static final String ERROR_ENTRY_ALREADY_EXISTS = "Data entry with this ID already exists."; // Reintroduced
