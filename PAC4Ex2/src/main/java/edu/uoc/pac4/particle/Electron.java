...
public class Electron extends Fermion {
    ...
    public void simulate() {
        System.out.printf("Electron [%s] with lepton number %d is stable and does not decay.%n",
    ...
    @Override
    public Electron clone() throws CloneNotSupportedException {
        return (Electron) super.clone();
    }
}
